    ...
    <>
      {show && (
        <button
          ...
          className="animate-fade-enter-sm fixed right-4 bottom-[8.5rem] md:bottom-8 z-50 w-11 h-11 flex items-center justify-center rounded-full md:bg-idm-gold-warm/15 md:border md:border-idm-gold-warm/30 text-idm-gold-warm/70 hover:text-idm-gold-warm md:hover:bg-idm-gold-warm/20 md:hover:border-idm-gold-warm/50 md:hover:shadow-[0_0_20px_rgba(239,249,35,0.2)] transition-all duration-300 cursor-pointer"
        >
